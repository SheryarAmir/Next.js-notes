...
const fruits = ["apple", "banana", "mango", "pineApple", "appricot", "watermealen"];
...
const numberToString = num.map((curElm) => curElm.toString());
...
const names = ["sheryarRastogi", "amir", "zain", "rahat", "farhan"];
