...
let longsen:string="this is is sheryar amir "
let shortsen:string=longsen.slice(10)
console.log(shortsen)


let sen:string="allowUnreachableCode,allowUnusedLabels,alwaysStrict,exactOptionalPropertyTypes,"
let sen1:string="allowUnreachableCode,allowUnusedLabels,alwaysStrict,exactOptionalPropertyTypes,"
...
function isdEven(a:number):boolean{
  return a%2 ===0;
}
...
const hello=( lastname:string , rollnumber:number)=>{  
  //the two name and id is called parameters.
...
const classname=( classname:string , section:number):string =>{  
